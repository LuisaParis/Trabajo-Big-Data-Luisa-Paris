...
# Cargar mis docs
filenames <- list.files(getwd(), pattern = "Acuerdo1.txt") 
...
write.csv(freq[ord],"word_freq_Acuerdo1.csv")

word_freq_acuerdos <- read.csv("word_freq_Acuerdo1.csv", header=TRUE,stringsAsFactors = FALSE)
...
write.csv(ldaOut.topics,file=paste("LDAGibbs",k,"DocsToTopicsAcuerdo1.csv"))

#top 6 terms in each topic
ldaOut.terms <- as.matrix(terms(ldaOut,6))
write.csv(ldaOut.terms,file=paste("LDAGibbs",k,"TopicsToTermsAcuerdo1.csv"))

#probabilities associated with each topic assignment
topicProbabilities <- as.data.frame(ldaOut@gamma)
write.csv(topicProbabilities,file=paste("LDAGibbs",k,"TopicProbabilitiesAcuerdo1.csv"))
...
#write to file
write.csv(topic1ToTopic2,file=paste("LDAGibbs",k,"Topic1ToTopic2Acuerdo1.csv"))
write.csv(topic2ToTopic3,file=paste("LDAGibbs",k,"Topic2ToTopic3Acuerdo1.csv"))
