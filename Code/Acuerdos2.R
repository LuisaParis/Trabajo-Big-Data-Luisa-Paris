...
# Cargar mis docs
filenames <- list.files(getwd(), pattern = "Acuerdo2.txt") 
...
write.csv(freq[ord],"word_freq_Acuerdo2.csv")

word_freq_acuerdos <- read.csv("word_freq_Acuerdo2.csv", header=TRUE,stringsAsFactors = FALSE)
...
write.csv(ldaOut.topics,file=paste("LDAGibbs",k,"DocsToTopicsAcuerdo2.csv"))

#top 6 terms in each topic
ldaOut.terms <- as.matrix(terms(ldaOut,6))
write.csv(ldaOut.terms,file=paste("LDAGibbs",k,"TopicsToTermsAcuerdo2.csv"))

#probabilities associated with each topic assignment
topicProbabilities <- as.data.frame(ldaOut@gamma)
write.csv(topicProbabilities,file=paste("LDAGibbs",k,"TopicProbabilitiesAcuerdo2.csv"))
...
#write to file
write.csv(topic1ToTopic2,file=paste("LDAGibbs",k,"Topic1ToTopic2Acuerdo2.csv"))
write.csv(topic2ToTopic3,file=paste("LDAGibbs",k,"Topic2ToTopic3Acuerdo2.csv"))
